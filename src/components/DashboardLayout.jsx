...
const DashboardLayout = () => {
    ...
    const [url, setUrl] = useState('https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&per_page=15')
    ...
    return (
        <div className='text-white'>
            {loading ? <div className='flex items-center justify-center h-screen w-full'><Loader /></div>
                : <div className='grid grid-cols-2 gap-8 place-items-center p-8 w-full'>
